...
/**
 * UsernamePasswordAuthenticationToken 会触发AuthenticationProvider 找对应的处理类，如果自定义 token 就可以实现
 * AuthenticationProvider  然后supports 传入UsernamePasswordAuthenticationToken
 *
 * @author hdf
 */
public class AdminUsernamePasswordAuthenticationFilter extends
    ...
    public AdminUsernamePasswordAuthenticationFilter(String loginPath) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        password = password + sysUser.getSalt();

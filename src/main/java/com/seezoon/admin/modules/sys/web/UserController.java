...
import com.seezoon.boot.common.utils.BtRemoteValidateResult;
...
public class UserController extends BaseController {
    ...
    public ResponeModel getUserInfo() throws InterruptedException {
        ...
        menus.stream().filter((v) -> StringUtils.isNotEmpty(v.getPermission())).forEach((menu) -> {
